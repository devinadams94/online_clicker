...
export default function DirectAuthPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // First try to fetch the user directly
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6">
      <div className="w-full max-w-md card bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold text-center mb-6">Direct Auth Check</h1>
        ...
        <div className="text-center">
          <p className="text-sm mt-4">
            <Link href="/fix-password" className="text-blue-600 hover:underline">
